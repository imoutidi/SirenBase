...
void DisplayReturnCode(t_rc rc)
{
	...
	/* return codes for RECORD MODULE (REM) */
        ...
        case REM_INVALIDRID:		msg = "REM:Invalid RID"; break;
	case REM_INVALIDREC:		msg = "REM:Invalid record"; break;
	case REM_INVALIDRECSIZE:	msg = "REM:Invalid record size"; break;
	...
	case INXM_INVALIDRECSIZE:		msg = "INXM:Invalid record size"; break;
        case INXM_IHCLOSED:				msg = "INXM: handle closed"; break;
	case INXM_KEY_NOT_FOUND:		msg = "INXM:Key not found in b+ tree"; break;
